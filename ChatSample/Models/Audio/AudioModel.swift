...
final class AudioModel {
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(AudioModel.didReceiveMeteringLevelUpdate),
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(AudioModel.didFinishRecordOrPlayAudio),
